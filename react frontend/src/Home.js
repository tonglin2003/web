...
function Home() {
    return (
        <>
            <Header />
            <div className="p-5 text-center " id="back">
                <h1 className="mb-2">JUSTWORKS</h1> <br></br>
                <h4 className="mb-3">Our mission is to help entrepreneurs and businesses grow with confidence. We do this with a simple and friendly platform, expert <br></br>
                    <br></br>
