...
const NewProfile = () => {
    ...
    if(!loading && profileUser ===-1 && !profileUser){
        return <p className="font">Opps. Something went wrong</p>
    }
    //DEBUG USER DATA (END)-----------------
        ...
        <>
            <form method='post' className="profile center font" style={{ width: "100%",}}
                ...
                <fieldset style={{ maxWidth: "800px", width: "800px", paddingTop: "30px" }} className=" profile contain">
                    ...
                    {/*{!(isEditMode) && <Spacer/>}*/}
                    {/*{!(isEditMode) && <><h4 style={{display: "inline"}} className="title_font">Latest Products</h4> <Link to="#" style={{textDecoration: "none", display: "inline"}}>Browse all</Link></>}*/}
                    ...
                    {/* CONTACT section --------------------------------------------------*/}
                    <h2 className="title_font" style={{paddingTop:"20px"}}>Contact</h2>
                    <hr></hr>
                    ...
                    {isEditMode && <label className="font" >Website or Linkedin: </label>}
                    {isEditMode && <input
                        type="text"
                        value={newWebsite}
                        className="font"
                    ...
                    {!(isEditMode) && " "}
                    {!(isEditMode) && location}
                    {isEditMode && <label className="font">Location:</label>}
                    {isEditMode && <input
                        type="text"
                        className="font"
                        value={newLocation}
